...
public class CommandPathScanner extends Base {
    ...
    public static final CommandPathScanner getInstance() {
        return scanner;
    }
    ...
    public void getAndSetFromAnnotation(Class<? extends ICommand> cls) {
        try {
            Constructor<? extends ICommand> c = cls.getConstructor(JavaPlugin.class);
            ICommand command = c.newInstance(getPlugin());
